...
export function CartContextProvider({children}){
    ...
    <CartContext.Provider value={{addToCartHandler,getItemsOfCart,cartItems,setCartItems,itemInCartFlag,incrementCartQuantity,decrementCartQuantity,removeProductFromCart,isLoading,inputedDiscountCode,setInputedDiscountCode,discountPercent, setDiscountPercent,discountHandler,buyItems, setBuyItems}}>
        {children}
